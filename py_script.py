...
# urls
url_template = "https://www.qantas.com/hotels/properties/18482?adults=2&checkIn={}&checkOut={}&children=0&infants=0&location=London%2C%20England%2C%20United%20Kingdom&page=1&payWith=cash&searchType=list&sortBy=popularity"
...
csv_headers = ["hotels_id", "check_in", "check_out" , "Room Name", "Rate Name", "Number of Guests", "Cancellation Policy", "Price", "Currency", "Top Deal"]
...
try:
    with open(csv_file, mode='w', newline='') as file:
        ...
        for check_in, check_out in date_combinations:
            url = url_template.format(check_in, check_out)
            availability_url = availability_base_url.format(check_in, check_out)
            hotels_id = "18482"
                            ...
                            for availability_room in availability_rooms:
                                ...
                                if room_name in room_dict:
                                    for offer in availability_room.get("offers", []):
                                        ...
                                        top_deal = offer.get("promotion", {}).get("name", "") == "Top Deal" if offer.get("promotion") else False
